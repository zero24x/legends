...
const string strMessageMagic = "LEGENDS Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LEGENDS", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1525333837;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1930709 : 1930709;
        ...
        assert(block.hashMerkleRoot == uint256("0xbecc8005db339592349855538f12b4df7db61fbafbeef1044ad813900ce47843"));
...
unsigned char pchMessageStart[4] = { 0xf0, 0x11, 0x90, 0xe1 };
